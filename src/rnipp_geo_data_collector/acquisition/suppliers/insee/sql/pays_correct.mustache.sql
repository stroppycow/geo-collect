COPY (
    SELECT 
        ...
        CASE WHEN t_add_or_replace.is_present_add_or_replace is not null THEN t_add_or_replace.long_label ELSE t_raw.long_label END AS long_label,
        CASE WHEN t_add_or_replace.is_present_add_or_replace is not null THEN t_add_or_replace.iso3166alpha2_code ELSE t_raw.iso3166alpha2_code END AS iso3166alpha2_code,
        CASE WHEN t_add_or_replace.is_present_add_or_replace is not null THEN t_add_or_replace.iso3166alpha3_code ELSE t_raw.iso3166alpha3_code END AS iso3166alpha3_code,
        CASE WHEN t_add_or_replace.is_present_add_or_replace is not null THEN t_add_or_replace.iso3166num_code ELSE t_raw.iso3166num_code END AS iso3166num_code,
